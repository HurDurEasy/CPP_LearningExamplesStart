...
int main()
{
	...
	//char			od - 128 do 127, używane także do zapisywania znaków ASCI ('a','b','c','1','2','3'), CAŁE BEZ PRZECINKA
	//int	 		od - 2'147'483'648 do 2'147'483'647, liczby CAŁE (bez przecinka)
	//unsigned int	od 0 do 4'294'967'295, liczby CAŁE, DODATNIE
	//float			3.4E + / -38 (7 cyfr) //liczby zmiennoprzecinkowe, 7 cyfr po przecinku, ujemne i dodatnie
